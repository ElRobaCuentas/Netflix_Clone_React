    ...
    return (
        <>
            ...
            <div className="wrapper">
                <section id="section1">
                    {/* <a href="#section2" className="arrow__btn izquierda">›</a> */}
                    <div className="item">
                    ...
                    <a href="#section2" className="arrow__btn derecha">›</a>
                </section>
                
                <section id="section2">
                    <a href="#section1" className="arrow__btn izquierda">‹</a>
                    <div className="item">
                    ...
                    <a href="#section3" className="arrow__btn  derecha">›</a>
                </section>
                ...
                <section id="section3">
                    ...
                    {/* <a href="#section1" className="arrow__btn derecha">›</a> */}
                </section>
            </div>
        </>
    )
